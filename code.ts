    ...
    localStyles.map(style => {
      ...
      layered.forEach(([key, value], idx) => {
        ...
        cols.forEach(([colorKey, colorValue], idx) => {
          ...
          const paint: SolidPaint = style.paints[0] as SolidPaint;
          ...
          if (style.name === `${category}/${colorKey}`) {
            ...
            if (pr != r || pg != g || pb != b) {
              ...
              const solidPaint: SolidPaint = { type: "SOLID", color: { r: rgb.r, g: rgb.g, b: rgb.g } }
...
function createPages() {
  ...
  const white: SolidPaint = { type: "SOLID", color: { r: 1.0, g: 1.0, b: 1.0 } }
  const black: SolidPaint = { type: "SOLID", color: { r: 0.0, g: 0.0, b: 0.0 } }
...
function createTitle(category = "") {
  ...
  const solidPaint: SolidPaint = { type: "SOLID", color: { r: 1.0, g: 1.0, b: 1.0 } }
...
function generateStylesFromTokens(colorMode = "dark") {
  ...
  darkColors.forEach(([key, value], idx) => {
    ...
    cols.forEach(([key, color], idx) => {
      ...
      if (!exists) {
        const solidPaint: SolidPaint = { type: "SOLID", color: { r: red, g: green, b: blue }, opacity: color.value.alpha }
        const paint = figma.createPaintStyle();
        paint.paints = [solidPaint]
